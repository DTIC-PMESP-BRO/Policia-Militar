...
export function cautelaCloseContainer(member: GuildMember, data: FirebaseFirestore.DocumentData, timestamp: string) {
        ...
        components: [
            ...
            createTextDisplay(
                brBuilder(
                    ...
                    `**OPM:** ${data.opm}`,
                    `**Modelo da viatura:** ${data.modelo}`,
                    `**Prefixo:** [${data.prefixo}](https://discord.com/channels/1407933677312151602/${data.call})`,
                    `**Motivo:** ${data.motivo}`,
